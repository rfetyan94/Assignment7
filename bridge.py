...
def scan_blocks(chain, contract_info="contract_info.json"):
    ...
    # pull signer creds from top-level json (as per your note)
    with open(contract_info, 'r') as f:
        ci_all = json.load(f)
    ...
    if chain == 'source':
        ...
        event_filter = source_contract.events.Deposit.create_filter(fromBlock=from_block)
        ...
        event_filter = destination_contract.events.Unwrap.create_filter(fromBlock=from_block)
        tx_w3 = w3_source
